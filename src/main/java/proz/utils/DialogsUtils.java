...
public class DialogsUtils
{
    ...
    public static void aboutApplicationDialog()
    {
        ...
        informationAlert.setHeaderText("SuperTester - version 1.0");
        informationAlert.setContentText("Application created as a project for event-driven programming class.\n" +
                "This is a simple test system, can be used to test students, teachers can create new tests, " +
                "edit or delete existing ones. Results are stored in database.\n" +
                "\nAuthors:\n" +
                "Zbigniew Dynowski, Małgorzata Górecka\n" +
                "Anna Pawlus, Małgorzata Sokół\n");
    ...
    public static void studentGuideDialog()
    {
        ...
        informationAlert.setContentText("1. Choose category by clicking on it.\n" +
                ...
                "4. Each test has only one possible answer that can be selected.\n" +
                "5. After answering to all of questions press \"Finish\" button to finish and see the results.");
        informationAlert.showAndWait();
    }
    ...
    public static void notEnoughQuestionsDialog()
    {
        Alert informationAlert = new Alert(Alert.AlertType.INFORMATION);
        informationAlert.setTitle("Not enough questions");
        informationAlert.setHeaderText("Test does not contain 5 questions.");
        informationAlert.setContentText("To solve test it must contain at least 5 questions.");
        informationAlert.showAndWait();
    }
